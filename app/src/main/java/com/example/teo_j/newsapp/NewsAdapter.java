package com.example.teo_j.newsapp;
...
public class NewsAdapter extends ArrayAdapter<News> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Get the Date from the News Article object
        String contributorTag = currentNews.getContributorTag();
        // Set the Date of the current News Article in that TextView
        viewHolder.authorTextView.setText(contributorTag);
    ...
    private class ViewHolder {
        ...
        private ViewHolder(@NonNull View view) {
            ...
            this.sectionTextView = view
                    .findViewById(R.id.section_text_view);
            this.dateTimeTextView = view
                    .findViewById(R.id.date_text_view);
            this.authorTextView = view
                    .findViewById(R.id.contributor_text_view);
        }
    }
}