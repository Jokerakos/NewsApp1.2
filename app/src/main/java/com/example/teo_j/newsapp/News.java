...
public class News {
     ...
     */
    public News(String title, String section, String description, String dateTime, String url, String contributorTag) {
        mTitle = title;
        mSection = section;
        mDescription = description;
        mDateTime = dateTime;
        mUrl = url;
        mAuthor = contributorTag;
    }
    ...
    public String getContributorTag() {
        return mAuthor;
    }
